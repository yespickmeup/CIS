            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addComponent(tf_field14, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(tf_field15, javax.swing.GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//                btn_0.doClick();
    ...
    public static void init_tbl_miscellaneous_fees(JTable tbl_miscellaneous_fees) {
        ...
        int[] tbl_widths_miscellaneous_fees = {100, 0, 30, 30, 0, 0, 0, 0, 0};
    ...
    public static void loadData_miscellaneous_fees(List<Banks.to_banks> acc) {
    ...
    public static class Tblmiscellaneous_feesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Bank", "Rate", "", "", "updated_at", "created_by", "updated_by", "status", "is_uploaded"
        };
        ...
        public Object getValueAt(int row, int col) {
            Banks.to_banks tt = (Banks.to_banks) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.bank;
                case 1:
                    return FitIn.fmt_wc_0(tt.bank) + " ";
                case 2:
...
//</editor-fold> 
    ...
    private void save_record() {
        ...
        if (row < 0) {
            ...
            int status = 0;
            int is_uploaded = 0;
            Banks.to_banks to = new Banks.to_banks(id, fee, created_at, updated_at, created_by, updated_by, status, is_uploaded);
            ...
            Banks.to_banks to2 = new Banks.to_banks(id, fee, created_at, updated_at, created_by, updated_by, status, is_uploaded);
            Window p = (Window) this;
            Dlg_confirm_action nd = Dlg_confirm_action.create(p, true);
            nd.setTitle("");
            nd.setCallback(new Dlg_confirm_action.Callback() {
    ...
    private void select_record() {
        ...
        Banks.to_banks to = (Banks.to_banks) tbl_miscellaneous_fees_ALM.get(row);
        if (col == 2) {
            tf_field15.setText(to.bank);
