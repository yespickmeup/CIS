 ...
 * @author Ronescape
 */
public class Dlg_classrooms extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_classrooms(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_classrooms(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_classrooms myRef;

    private void setThisRef(Dlg_classrooms myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_classrooms> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_classrooms create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_classrooms create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_classrooms dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_classrooms((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_classrooms((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_classrooms dialog = Dlg_classrooms.create(new javax.swing.JFrame(), true);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(5, 5, 5)
                        .addComponent(tf_field6, javax.swing.GroupLayout.DEFAULT_SIZE, 340, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
...
//                btn_0.doClick();
    ...
    public static void loadData_faculty_member_designations(List<Classrooms.to_classrooms> acc) {
    ...
    public static class Tblfaculty_member_designationsModel extends AbstractTableAdapter {
        ...
        public Object getValueAt(int row, int col) {
            Classrooms.to_classrooms tt = (Classrooms.to_classrooms) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.classroom;
                case 1:
    ...
    private void ret_data() {
        ...
        List<Classrooms.to_classrooms> data = Classrooms.ret_data(where);
...
//</editor-fold> 
    ...
    private void save_designation() {
        ...
        if (row < 0) {
            ...
            Classrooms.to_classrooms to = new Classrooms.to_classrooms(id, designation, created_at, updated_at, created_by, updated_by, status, is_uploaded);
...
//            nd.do_pass(services);
            ...
            Classrooms.to_classrooms to = (Classrooms.to_classrooms) tbl_faculty_member_designations_ALM.get(row);
            ...
            Classrooms.to_classrooms to1 = new Classrooms.to_classrooms(id, designation, created_at, updated_at, created_by, updated_by, status, is_uploaded);
...
//            nd.do_pass(services);
            ...
            tf_field6.setText(to.classroom);
        }
    }
}
