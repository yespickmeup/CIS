                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(tf_field14, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//                btn_0.doClick();
    ...
    public static void loadData_miscellaneous_fees(List<Credit_cards.to_credit_cards> acc) {
    ...
    public static class Tblmiscellaneous_feesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Card", "Rate", "", "", "updated_at", "created_by", "updated_by", "status", "is_uploaded"
        };
        ...
        public Object getValueAt(int row, int col) {
            Credit_cards.to_credit_cards tt = (Credit_cards.to_credit_cards) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.card;
                case 1:
    ...
    private void ret_data() {
        String where = "";
        List<Credit_cards.to_credit_cards> datas = Credit_cards.ret_data(where);
...
//</editor-fold> 
    ...
    private void save_record() {
        ...
        if (row < 0) {
            int id = 0;
            String fee = tf_field15.getText();
            double amount = FitIn.toDouble(tf_field14.getText());
            ...
            int status = 0;
            int is_uploaded = 0;
            Credit_cards.to_credit_cards to = new Credit_cards.to_credit_cards(id, fee, amount, created_at, updated_at, created_by, updated_by, status, is_uploaded);
            ...
            Credit_cards.to_credit_cards to = (Credit_cards.to_credit_cards) tbl_miscellaneous_fees_ALM.get(row);
            int id = to.id;
            String fee = tf_field15.getText();
            double amount = FitIn.toDouble(tf_field14.getText());
            ...
            Credit_cards.to_credit_cards to2 = new Credit_cards.to_credit_cards(id, fee, amount, created_at, updated_at, created_by, updated_by, status, is_uploaded);
            Window p = (Window) this;
            Dlg_confirm_action nd = Dlg_confirm_action.create(p, true);
            nd.setTitle("");
            nd.setCallback(new Dlg_confirm_action.Callback() {
    ...
    private void select_record() {
        ...
        Credit_cards.to_credit_cards to = (Credit_cards.to_credit_cards) tbl_miscellaneous_fees_ALM.get(row);
        if (col == 2) {
            tf_field15.setText(to.card);
            tf_field14.setText("" + FitIn.fmt_wc_0(to.amount));
        }
        if (col == 3) {
            Window p = (Window) this;
