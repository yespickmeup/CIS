...
public class Srpt_list_of_students_with_subjects {
    ...
    public static class field {
        ...
        public field(String enrollment_id, String student_no, String name, String course, int no, String subject_code, String description, double lec_units, double lab_units) {
