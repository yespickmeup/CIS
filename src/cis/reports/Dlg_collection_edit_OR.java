 ...
 * @author USER
 */
public class Dlg_collection_edit_OR extends javax.swing.JDialog {
...
//</editor-fold>
  ...
  private Dlg_collection_edit_OR(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    setUndecorated(true);
    initComponents();
    myInit();
  ...
  private Dlg_collection_edit_OR(java.awt.Dialog parent, boolean modal) {
    super(parent, modal);
    setUndecorated(true);
    initComponents();
    myInit();
  ...
  private Dlg_collection_edit_OR myRef;

  private void setThisRef(Dlg_collection_edit_OR myRef) {
    this.myRef = myRef;
  }
  private static java.util.Map<Object, Dlg_collection_edit_OR> dialogContainer = new java.util.HashMap();
  ...
  public static Dlg_collection_edit_OR create(java.awt.Window parent, boolean modal) {
  ...
  public static Dlg_collection_edit_OR create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

    if (parent instanceof java.awt.Frame) {

      Dlg_collection_edit_OR dialog = dialogContainer.get(parent);

      if (dialog == null) {
        dialog = new Dlg_collection_edit_OR((java.awt.Frame) parent, false);
    ...
    if (parent instanceof java.awt.Dialog) {
      ...
      if (dialog == null) {
        dialog = new Dlg_collection_edit_OR((java.awt.Dialog) parent, false);
        dialog.setModalityType(modalType);
        dialogContainer.put(parent, dialog);
        java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
        dialog.setThisRef(dialog);
  ...
  public static void main(String args[]) {
    ...
    Dlg_collection_edit_OR dialog = Dlg_collection_edit_OR.create(new javax.swing.JFrame(), true);
      ...
      .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
          ...
          .addGroup(jPanel1Layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(tf_customer_name, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE)))
...
//                btn_0.doClick();
  ...
  private void confirm() {
    if (tf_customer_name.getText().isEmpty()) {
      Alert.set(0, "Enter OR No.!");
      return;
    }
    List<Collection.to_collections> datas = Collection.ret_data((" where or_no like '" + tf_customer_name.getText() + "' limit 1"));

    if (!datas.isEmpty()) {
      Alert.set(0, "OR No. already exists!");
    ...
    nd.setTitle("");
    if (!datas.isEmpty()) {
      nd.do_pass("OR No. already exists do you still want to continue?");
    } else {
      nd.do_pass("Confirm Action");
    }
