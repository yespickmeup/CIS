            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGap(51, 51, 51)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(tf_field14, javax.swing.GroupLayout.DEFAULT_SIZE, 421, Short.MAX_VALUE)
...
//</editor-fold> 
    ...
    private void init_departments() {
        ...
        tr.setCallback(new TableRenderer.Callback() {
            ...
            public void ok(TableRenderer.OutputData data) {
                ...
                String where2 = "  where academic_year_id='" + acad.id + "'  and department_id='" + to.id + "'";
    ...
    private void init_acad_period_schedules() {
        ...
        acad_schedules = Academic_year_period_schedules.ret_data(" where academic_year_id='" + acad.id + "' and  department_id='" + dep.getId() + "'");
