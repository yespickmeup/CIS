 ...
 * @author USER
 */
public class Dlg_collection_edit_payor extends javax.swing.JDialog {
...
//</editor-fold>
  ...
  private Dlg_collection_edit_payor(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    setUndecorated(true);
    initComponents();
    myInit();
  ...
  private Dlg_collection_edit_payor(java.awt.Dialog parent, boolean modal) {
    super(parent, modal);
    setUndecorated(true);
    initComponents();
    myInit();
  ...
  public Dlg_collection_edit_payor() {
    super();
    setUndecorated(true);
    initComponents();
    myInit();
  ...
  private Dlg_collection_edit_payor myRef;

  private void setThisRef(Dlg_collection_edit_payor myRef) {
    this.myRef = myRef;
  }
  private static java.util.Map<Object, Dlg_collection_edit_payor> dialogContainer = new java.util.HashMap();
  ...
  public static Dlg_collection_edit_payor create(java.awt.Window parent, boolean modal) {
  ...
  public static Dlg_collection_edit_payor create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

    if (parent instanceof java.awt.Frame) {

      Dlg_collection_edit_payor dialog = dialogContainer.get(parent);

      if (dialog == null) {
        dialog = new Dlg_collection_edit_payor((java.awt.Frame) parent, false);
    ...
    if (parent instanceof java.awt.Dialog) {
      ...
      if (dialog == null) {
        dialog = new Dlg_collection_edit_payor((java.awt.Dialog) parent, false);
        dialog.setModalityType(modalType);
        dialogContainer.put(parent, dialog);
        java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
        dialog.setThisRef(dialog);
  ...
  public static void main(String args[]) {
    ...
    Dlg_collection_edit_payor dialog = Dlg_collection_edit_payor.create(new javax.swing.JFrame(), true);
