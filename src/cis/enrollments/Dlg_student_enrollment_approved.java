 ...
 * @author Ronescape
 */
public class Dlg_student_enrollment_approved extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_student_enrollment_approved(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_student_enrollment_approved(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_student_enrollment_approved() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_student_enrollment_approved myRef;

    private void setThisRef(Dlg_student_enrollment_approved myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_student_enrollment_approved> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_student_enrollment_approved create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_student_enrollment_approved create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_student_enrollment_approved dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_student_enrollment_approved((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_student_enrollment_approved((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_student_enrollment_approved dialog = Dlg_student_enrollment_approved.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Enrollment Application Successful");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup()
                        .addGroup(jPanel14Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel14Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(tf_field8, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE))
                            .addGroup(jPanel14Layout.createSequentialGroup()
    ...
    public void do_pass(Enrollments.to_enrollments enrollment, String student_no) {
        tf_field10.setText(student_no);
