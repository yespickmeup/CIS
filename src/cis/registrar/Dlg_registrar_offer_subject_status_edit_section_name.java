 ...
 * @author User
 */
public class Dlg_registrar_offer_subject_status_edit_section_name extends javax.swing.JDialog {
    ...
    public static class OutputData {
        ...
        public final String new_section_name;
        
        public OutputData(String new_section_name) {
...
//</editor-fold>
    ...
    private Dlg_registrar_offer_subject_status_edit_section_name(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_registrar_offer_subject_status_edit_section_name(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_registrar_offer_subject_status_edit_section_name() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_registrar_offer_subject_status_edit_section_name myRef;
    
    private void setThisRef(Dlg_registrar_offer_subject_status_edit_section_name myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_registrar_offer_subject_status_edit_section_name> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_registrar_offer_subject_status_edit_section_name create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_registrar_offer_subject_status_edit_section_name create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {
        
        if (parent instanceof java.awt.Frame) {
            
            Dlg_registrar_offer_subject_status_edit_section_name dialog = dialogContainer.get(parent);
            
            if (dialog == null) {
                dialog = new Dlg_registrar_offer_subject_status_edit_section_name((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_registrar_offer_subject_status_edit_section_name((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_registrar_offer_subject_status_edit_section_name dialog = Dlg_registrar_offer_subject_status_edit_section_name.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jLabel22.setText("New Section Name:");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(tf_field16, javax.swing.GroupLayout.DEFAULT_SIZE, 294, Short.MAX_VALUE)
...
//        nd.do_pass(services);
    ...
    private void ok1() {
        String section_name = tf_field14.getText();
        if (section_name.isEmpty() || section_name.equalsIgnoreCase(tf_field16.getText())) {
            Alert.set(0, "Enter new section name");
            tf_field14.grabFocus();
            return;
        }
        if (callback != null) {
            callback.ok(new CloseDialog(this), new OutputData(section_name));
        }
    }
}
