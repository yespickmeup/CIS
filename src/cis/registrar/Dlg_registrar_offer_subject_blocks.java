 ...
 * @author User
 */
public class Dlg_registrar_offer_subject_blocks extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_registrar_offer_subject_blocks
     */
...
//</editor-fold>
    ...
    private Dlg_registrar_offer_subject_blocks(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_registrar_offer_subject_blocks(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_registrar_offer_subject_blocks() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_registrar_offer_subject_blocks myRef;

    private void setThisRef(Dlg_registrar_offer_subject_blocks myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_registrar_offer_subject_blocks> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_registrar_offer_subject_blocks create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_registrar_offer_subject_blocks create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_registrar_offer_subject_blocks dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_registrar_offer_subject_blocks((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_registrar_offer_subject_blocks((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_registrar_offer_subject_blocks dialog = Dlg_registrar_offer_subject_blocks.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(tf_field4, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Courses", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
