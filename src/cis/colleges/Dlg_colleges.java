 ...
 * @author Ronescape
 */
public class Dlg_colleges extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_colleges(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_colleges(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_colleges myRef;

    private void setThisRef(Dlg_colleges myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_colleges> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_colleges create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_colleges create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_colleges dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_colleges((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_colleges((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_colleges dialog = Dlg_colleges.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        tf_user_screen_name2.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(1, 1, 1))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(tf_user_screen_name2)
                                .addGap(0, 0, 0)
...
//                btn_0.doClick();
    ...
    //<editor-fold defaultstate="collapsed" desc=" colleges "> 
    ...
    public static void init_tbl_colleges(JTable tbl_colleges) {
        ...
        int[] tbl_widths_colleges = {100, 120, 160, 60, 60, 50, 0, 0, 0, 0};
    ...
    public static void loadData_colleges(List<to_colleges> acc) {
    ...
    public static class TblcollegesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "College", "Admin", "Department", "Courses", "Status", "", "created_by", "updated_by", "status", "is_uploaded"
        };
        ...
        public Object getValueAt(int row, int col) {
            to_colleges tt = (to_colleges) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.college_name;
                case 1:
                    return " " + tt.college_admin_name;
                case 2:
                    return " " + tt.department_name;
                case 3:
                    return "       " + tt.no_of_courses;
                case 4:
                    if (tt.status == 0) {
                        return " Inactive";
                    } else {
    ...
    private void save_college() {
        ...
        if (row < 0) {
            int id = 0;
            String college_name = tf_field.getText();
            Field.Combo co = (Field.Combo) tf_user_screen_name1;
            int college_admin_id = FitIn.toInt(co.getId());
            String college_admin_name = co.getText();

            Field.Combo dep = (Field.Combo) tf_user_screen_name2;
            String department_name = dep.getText();
            String department_id = dep.getId();
            if (department_id.isEmpty() || department_id == null || department_name.isEmpty()) {
                Alert.set(0, "Choose Department");
                tf_user_screen_name2.grabFocus();
                return;
            }
            ...
            int is_uploaded = 0;
            int no_of_courses = 0;
            Colleges.to_colleges coll = new Colleges.to_colleges(id, college_name, college_admin_id, college_admin_name, department_name, department_id, created_at, updated_at, created_by, updated_by, status, is_uploaded, no_of_courses);
            ...
            int is_uploaded = 2;
            int no_of_courses = 0;
            Colleges.to_colleges to2 = new Colleges.to_colleges(id, college_name, college_admin_id, college_admin_name, department_name, department_id, created_at, updated_at, created_by, updated_by, status, is_uploaded, no_of_courses);
            Window p = (Window) this;
            Dlg_confirm_action nd = Dlg_confirm_action.create(p, true);
            nd.setTitle("");
    ...
    private void select_college() {
        ...
        if (col == 5) {
            ...
            Field.Combo co = (Field.Combo) tf_user_screen_name1;
            tf_field.setText(to.college_name);
            co.setId("" + to.college_admin_id);
            co.setText(to.college_admin_name);
    ...
    private void init_departments() {
        ...
        List<Departments.to_departments> deps = Departments.ret_data(where);
        ...
        JLabel[] labels = {};
        int[] tbl_widths_customers = {tf_user_screen_name2.getWidth()};
        int width = 0;
        String[] col_names = {""};
        TableRenderer tr = new TableRenderer();
        TableRenderer.setPopup(tf_user_screen_name2, obj, labels, tbl_widths_customers, col_names);
