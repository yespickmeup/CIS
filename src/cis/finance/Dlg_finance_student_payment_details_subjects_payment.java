...
import static cis.finance.Dlg_finance_payment.tbl_mode_of_payments_ALM;
...
//</editor-fold>
  ...
  private void initComponents() {
      ...
      .addGroup(jPanel8Layout.createSequentialGroup()
        ...
        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          ...
          .addGroup(jPanel8Layout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(jDateChooser5, javax.swing.GroupLayout.DEFAULT_SIZE, 505, Short.MAX_VALUE)))
        .addContainerGap())
    );
    ...
    jLabel87.setText("Or No.:");

    tf_field24.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
    ...
    jPanel4Layout.setVerticalGroup(
      ...
      .addGroup(jPanel4Layout.createSequentialGroup()
        ...
        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
          ...
          .addComponent(tf_field24, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
        .addGap(5, 5, 5)
        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
...
//                btn_0.doClick();
  ...
  private void count_tender() {
    ...
    double total_tendered = cash + check + credit_card + online + discount;
    ...
    double total_for_cash = check + credit_card + online + discount;
    double total_for_check = cash + credit_card + online + discount;
    double total_for_credit_card = cash + check + online + discount;
    double total_for_online = cash + check + credit_card + discount;
    double total_for_discount = cash + check + credit_card + online;
    ...
    if (remaining < 0 && tf_discount.hasFocus()) {
      remaining = (tendered - total_for_discount);
      tf_discount.setText(FitIn.fmt_wc_0(remaining));
    }

    total_tendered = cash + check + credit_card + online + discount;
    tf_field20.setText(FitIn.fmt_wc_0(total_tendered));
  ...
  private void set_change() {
    ...
    Window p = (Window) Dlg_finance_student_payment_details_subjects_payment.this;
  ...
  private void payment() {
    ...
    String or_no = tf_field24.getText();
    String payment_type = "Add Subject";
    if (is_drop == 1) {
      payment_type = "Drop Subject";
    }
    int ref_id = 0;

    String school_year = pay_stud.academic_year;
    String period = pay_stud.year_level;
    ...
    String or = Enrollment_sls_payments.add_data(payment, subjects, remaining, is_drop, drop_charge, to_collections);
    c_transaction_no = or;
