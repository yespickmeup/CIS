    ...
    Thread t = new Thread(new Runnable() {
      ...
      public void run() {
        ...
        if (!assessments.isEmpty()) {
          ...
          List<Enrollment_assessment_discounts.to_enrollment_assessment_discounts> discounts = Enrollment_assessment_discounts.ret_data(" where enrollment_id = '" + assess.enrollment_id + "' and status=1 limit 1");
