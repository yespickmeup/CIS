...
//</editor-fold>
    ...
    private void set_previledge() {
        ...
        for (User_previleges.to_user_privileges to : datas) {
            if (to.privilege.equalsIgnoreCase("Service Departments")) {
                jLabel7.setEnabled(true);
                jLabel7.setBackground(new java.awt.Color(96, 188, 219));
            }

//            if (to.privilege.equalsIgnoreCase("Service Department Members")) {
////                jLabel8.setEnabled(true);
////                jLabel8.setBackground(new java.awt.Color(96, 188, 219));
//            }
//            if (to.privilege.equalsIgnoreCase("Service Transaction Type")) {
