 ...
 * @author Ronescape
 */
public class Dlg_faculty_member_designation_group extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_faculty_member_designation_group(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_faculty_member_designation_group(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_faculty_member_designation_group() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_faculty_member_designation_group myRef;

    private void setThisRef(Dlg_faculty_member_designation_group myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_faculty_member_designation_group> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_faculty_member_designation_group create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_faculty_member_designation_group create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_faculty_member_designation_group dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_faculty_member_designation_group((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_faculty_member_designation_group((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_faculty_member_designation_group dialog = Dlg_faculty_member_designation_group.create(new javax.swing.JFrame(), true);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(5, 5, 5)
                        .addComponent(tf_field6, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
...
//                btn_0.doClick();
    ...
    public static void loadData_faculty_member_designations(List<to_faculty_member_designation_groups> acc) {
    ...
    public static class Tblfaculty_member_designationsModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Designation", "", "created_at", "updated_at", "created_by", "updated_by", "status", "is_uploaded"
        };
        ...
        public Object getValueAt(int row, int col) {
            to_faculty_member_designation_groups tt = (to_faculty_member_designation_groups) getRow(row);
            switch (col) {
                case 0:
    ...
    private void ret_data() {
        String where = " order by group_name asc ";
        List<to_faculty_member_designation_groups> data = Faculty_member_designation_groups.ret_data(where);
...
//</editor-fold> 
    ...
    private void save_designation() {
        ...
        if (row < 0) {
            ...
            to_faculty_member_designation_groups to = new to_faculty_member_designation_groups(id, designation, created_at, updated_at, created_by, updated_by, status, is_uploaded);
...
//            nd.do_pass(services);
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    Faculty_member_designation_groups.add_data(to);
                    Alert.set(1, "");
                    ret_data();
                    clear_designation();
                }
            ...
            to_faculty_member_designation_groups to = (to_faculty_member_designation_groups) tbl_faculty_member_designations_ALM.get(row);
            ...
            to_faculty_member_designation_groups to1 = new to_faculty_member_designation_groups(id, designation, created_at, updated_at, created_by, updated_by, status, is_uploaded);
...
//            nd.do_pass(services);
            nd.setCallback(new Dlg_confirm_action.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_action.OutputData data) {
                    closeDialog.ok();
                    Faculty_member_designation_groups.update_data(to1);
                    Alert.set(2, "");
                    ret_data();
                    clear_designation();
                }
...
//            nd.do_pass(services);
            nd.setCallback(new Dlg_confirm_delete.Callback() {
                ...
                public void ok(CloseDialog closeDialog, Dlg_confirm_delete.OutputData data) {
                    closeDialog.ok();
                    Faculty_member_designation_groups.delete_data(to);
                    Alert.set(3, "");
                    ret_data();
                    clear_designation();
                }
            ...
            tf_field6.setText(to.group_name);
        }
    }
}
